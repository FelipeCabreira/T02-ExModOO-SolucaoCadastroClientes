...
public class DemoCriaArquivo{ 
    ...
    public static void main(String[] args){ 
        ...
        System.out.println("DIRETORIO: " + currDir);
        // Monta o nome do arquivo 
        String nameComplete = currDir+"\\"+"numeros.dat"; 
        System.out.println("DIRETORIO ATE O ARQUIVO: " + nameComplete);
        ...
        try (PrintWriter writer = new PrintWriter(Files.newBufferedWriter(path, Charset.defaultCharset()))){ 
            for(int i=0;i<100;i++){ 
                ...
                writer.print(nro+","); 
                System.out.println("NUMEROS: " + nro);
            } 
            // Sorteia e grava um último numero seguido de "\n" 
            int nro = sorteia.nextInt(1000); 
            writer.print(nro+"\n");
            System.out.println("TOTAL DE NUMEROS: " + nro); 
        }catch (IOException x){ 
